...
/**
 * This implementation was obtained by converting the C++ code of the negFIN algorithm to Java. The
 * C++ code of this algorithm was provided by Nader Aryabarzan, available on GitHub via
 * https://github.com/aryabarzan/negFIN/.
 *
 * <p>Both the C++/Java code of the negFIN algorithms are respectively based on the C++/Java code of
 * the "FIN algorithm", the algorithm which is presented in: "Z. H. Deng and S. L. Lv. (2014). Fast
 * mining frequent itemsets using Nodesets. Expert System with Applications, 41, 4505–4512"
 *
 * @author Nader Aryabarzan (Copyright 2018) @Email aryabarzan@aut.ac.ir or aryabarzan@gmail.com
 */
public class AlgoNegFIN {
   ...
   */
  public void constructing_frequent_itemset_tree(
      SetEnumerationTreeNode curNode, int level, int sameCount) throws IOException {
   ...
   */
  void writeItemsetsToFile(SetEnumerationTreeNode curNode, int sameCount) throws IOException {
