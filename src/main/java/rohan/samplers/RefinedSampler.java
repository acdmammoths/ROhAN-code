...
/** This class implements {@link Sampler} using the DirectROA (Refined) method. */
public class RefinedSampler implements Sampler {
  /**
   * Samples a dataset from the uniform distribution of datasets with the same row and column
   * margins as the original dataset using the DirectROA method.
   *
