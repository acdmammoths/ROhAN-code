...
public class RefinedMatrix extends GmmtMatrix {
  ...
  public RefinedMatrix(SparseMatrix inMatrix) {
    super(inMatrix);
  }
   ...
   */
  public int[] getDegreeAndTotalNumSwapPairs() {
   ...
   */
  public int getAdjMatrixTotalNumSwapPairs(
      Edge swappableEdge1,
      Edge swappableEdge2,
      Edge newEdge1,
      Edge newEdge2,
   ...
   */
  public int getNumSwapPairsFactor(int row1, int row2) {
   ...
   *     adjacent matrix
   */
  public int getNumSwapPairs(int numSwapPairsFactor, Vector swappableRow1, Vector swappableRow2) {
   ...
   *     current matrix
   */
  public int getAdjMatrixNumSwapPairs(int numSwapPairsFactor, Vector newRow1, Vector newRow2) {
  ...
  public SwappableAndNewEdges getSwappableAndNewEdges(Random rnd) {
    ...
    final Edge newEdge1 = new Edge(sampledEdge1.row, sampledEdge2.col, sampledEdge1.index);
    final Edge newEdge2 = new Edge(sampledEdge2.row, sampledEdge1.col, sampledEdge2.index);
