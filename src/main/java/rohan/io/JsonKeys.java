...
public class JsonKeys {
  ...
  public static final String freqItemsetsPath = "freqItemsetsPath";
  ...
  public static final String perturbationScore = "perturbationScore";
  ...
  public static final String samplePath = "samplePath";
