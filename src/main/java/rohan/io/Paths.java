...
public class Paths {
  ...
  private static final String rohanDir = "rohan";
  ...
  public static final String experConfsNumFreqItemsetsPath =
      concat(experConfsPath, numFreqItemsetsDir);
  public static final String experConfsRohanPath = concat(experConfsPath, rohanDir);
  ...
  public static final String experResultsRohanPath = concat(experResultsPath, rohanDir);
