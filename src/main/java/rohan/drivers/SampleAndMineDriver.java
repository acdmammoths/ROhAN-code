...
import rohan.mining.SampleAndMiner;
import rohan.samplers.Sampler;

/**
 * This class is a driver for sampling datasets using ROhAN or GMMT as well as mining the sampled
 * datasets.
 */
public class SampleAndMineDriver {
  /** Runs the driver. */
  public static void main(String[] args) {
    ...
    Sampler sampler = Sampler.getNewSampler(samplerType);
    if (sampler == null) {
